	...
	class Internal_Tags_Nag {
		...
		public function display() {
			...
			if ( true == $display_nag ) {
				...
				echo '<div class="notice notice-success"><p>' . sprintf( esc_html__( 'Hello! I\'m David. I develop this plugin in my spare time. If it has helped you, please consider %1$s. You can disable this nag in %2$s.', 'internal-tags' ), '<a href="https://wordpress.org/support/plugin/internal-tags/reviews/" target="_blank">' . esc_html__( 'leaving a review', 'internal-tags' ) . '</a>', '<a href="' . esc_url( get_admin_url() . 'options-general.php?page=internal-tags' ) . '">' . esc_html__( 'settings', 'internal-tags' ) . '</a>' ) . '</p></div>';
